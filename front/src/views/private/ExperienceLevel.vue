        ...
        <b-col cols="12">
            <b-row class="align-items-center job-header-simple">
                ...
                <b-col cols="12" md="6" class="text-md-right mt-15 mt-md-0">
                    <b-button variant="primary" class="mr-10" @click="handleFormClick" title="Add New Experience Level">
            ...
            <div class="mt-20">
                ...
                >
                    <form @submit.prevent="handleSearch" autocomplete="off" class="p-3">
                        <b-form-group label="Enter Title" class="mb-10">
                ...
                <b-table
                    class="fit-table experience_level_table master-modern-table"
                    responsive
                    hover
                    show-empty
...
<script>
    ...
    import {
        deleteDependent,
        experienceLevelCreated, experienceLevelDeleted,
        experienceLevelUpdated, serverError,
    } from "../../util/notify";
    ...
    export default {
        ...
        data() {
            return {
                formTitle: 'Add Experience Level',
                dataSource: [],
                pagination: {
                    page: 1,
                    total: 0,
        ...
        methods: {
            ...
            handleFormClose() {
                ...
                this.formTitle = 'Add Experience Level';
                this.formErrors = new Error({});
            ...
            handleFormSubmit() {
                request({
                    method: "post",
                    url: this.formFields.id ? `experience/levels/update` : `experience/levels/create`,
            ...
            handleEditRecord(id) {
                request({
                    method: "get",
                    url: `/experience/levels/detail/${id}`,
                })
                .then((response) => {
                    this.formTitle = 'Edit Experience Level';
