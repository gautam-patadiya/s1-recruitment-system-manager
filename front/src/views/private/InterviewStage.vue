        ...
        <b-col cols="12">
            <b-row class="align-items-center job-header-simple">
                ...
                <b-col cols="12" md="6" class="text-md-right mt-15 mt-md-0">
                    <b-button variant="primary" class="mr-10" @click="handleFormClick" title="Add New Interview Stage">
            ...
            <div class="mt-20">
                ...
                >
                    <form @submit.prevent="handleFormSubmit" autocomplete="off">
                        ...
                        <b-form-group
                            label="Order *"
                            class="mb-10 required-input"
                            :state="formErrors.has('i_order') ? false : null"
                            :invalid-feedback="formErrors.first('i_order')"
                        >
                            <b-form-input
                                v-model="formFields.i_order"
                                :state="formErrors.has('i_order') ? false : null"
                            ></b-form-input>
                        </b-form-group>
                        <div class="filter-footer text-right">
                ...
                <b-table
                    class="fit-table interview-stages-table master-modern-table"
                    responsive
                    hover
                    show-empty
                ...
                >
                    ...
                    <template #cell(i_order)="data">
                        <span class="report-count-pill">{{data.item.i_order}}</span>
                    </template>
