        ...
        <b-col cols="12">
            <b-row class="align-items-center job-header-simple">
                ...
                <b-col cols="12" md="6" class="text-md-right mt-15 mt-md-0">
                    <b-button variant="primary" class="mr-10" @click="handleFormClick" title="Add New Document Type">
            ...
            <div class="mt-20">
                ...
                >
                    <form @submit.prevent="handleSearch" autocomplete="off" class="p-3">
                        <b-form-group label="Enter Name" class="mb-10">
                ...
                <b-table
                    class="fit-table document-types-table master-modern-table"
                    responsive
                    hover
                    show-empty
...
<script>
    ...
    import {
        deleteDependent, documentTypeCreated, documentTypeDeleted, documentTypeUpdated, serverError,
    } from "../../util/notify";
    ...
    export default {
        ...
        methods: {
            ...
            handleFormSubmit() {
                request({
                    method: "post",
                    url: this.formFields.id ? `document/types/update` : `document/types/create`,
